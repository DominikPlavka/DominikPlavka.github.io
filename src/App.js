  ...
  return (
    <div className='w-full min-h-screen m-0 p-0 bg-gradient-to-t from-gray-600 to-gray-800 flex flex-col'>
      ...
      <div className="w-4/5 md:w-4x5 lg:w-3/5 justify-center mx-auto my-24 bg-white shadow-myShadow">
        ...
        <div id="aboutMe" className='md:grid md:grid-cols-2 md:gap-8 bg-gray-100'>
          <div className='p-12'>
            <h2 className="text-3xl lg:text-4xl">My skills</h2>
            {projectData.map((project, index) => (
              <ProgressBar key={index} name={project.name} progression={project.progression} />
            ))
            }
          </div>
          <div className='p-12'>
        ...
        <div id="2ndRow" className='bg-gray-100'>
          <div className='p-12'>
            <h2 className="text-3xl lg:text-4xl">My skills</h2>
            {projectData.map((project, index) => (
          ...
          <div className='p-12'>
          <h2 className="text-3xl lg:text-4xl">About me</h2>
            <p className='mt-5'>Hello, my name is Dominik Plavka and Iam fresh graduate of Green Fox Academy. Before this "big step" in my life, I worked as Marketing Manager in various roles.</p>
            <p className='mt-5'>This experience can be very useful in web development as well, because I participated in web/graphic design and I created basic webpages for various clients.</p>
          </div>
        </div>
      </div>
